...
with st.sidebar:
    ...
    st.sidebar.markdown("[![LinkedIn]('https://content.linkedin.com/content/dam/me/business/en-us/amp/brand-site/v2/bg/LI-Logo.svg.original.svg')]('https://www.linkedin.com/in/alfikri-ramadhan/')")
